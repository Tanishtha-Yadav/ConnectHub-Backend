...
/**
 * Global exception handler for Room Service.
 * Catches exceptions thrown anywhere in controllers and returns
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleUnauthorized(UnauthorizedRoomAccessException ex) {
